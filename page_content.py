    ...
    try:
        ...
        for tag in taglist:
            ...
            if comment != None:
                ...
                continue
        comment_count = int(common.woff_change(comment, comment_TTGlyphs, comment_dict)[:-1])
        ...
        for desc in descrip_list:
            ...
            if score_mes != None:
                for x in score_mes.text.strip().split('\n'):
                    ...
                    score_digit.append(int(common.woff_change(detailist, number_TTGlyphs, number_dict)) / 10)
                    taste = score_digit[0],
...
def get_adress(soup, address_TTGlyphs, address_dict):
    ...
    location = common.woff_change(adress, address_TTGlyphs, address_dict)
    return location
